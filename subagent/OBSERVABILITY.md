...
- Routing: `router_completed_total`, `router_success_rate`, `router_quality_mean`, `router_quality_coverage`, `router_latency_p95`, `router_rollout_transitions`

Every ratio uses an explicit denominator. A zero denominator is unavailable rather than zero, and SLO findings require at least ten eligible samples. Zero-volume snapshots report insufficient data and cannot justify rollout promotion.
