...
export type BackendObservation =
	...
	| { kind: "model.executed"; at: number; model?: string; thinkingLevel?: string }
	| { kind: "tool.started"; at: number; toolCallId: string; toolName: string }
	| { kind: "tool.completed"; at: number; toolCallId: string; toolName: string; durationMs?: number; success: boolean; resultChars: number; resultTruncated: boolean; policyRejected?: boolean; error?: Error }
